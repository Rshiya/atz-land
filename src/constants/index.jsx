...
export const features = [
    ...
    //   text: "After we fire a signal, our best trader is managing it live to ensure maximum profit and eliminate risk ASAP. This is valid for EVERY trade. Usually crypto signal groups just forget about the trade after they give you a signal. We are in a league of our own.",
    //   button: {
  ...
  export const faq = [
    ...
    },
    {
      ...
      answer:
        "Our service is designed to adapt to your trading style. You have the flexibility to tweak settings, personalize alerts, and fine-tune parameters to match your unique preferences and goals. Whether you're a scalper, swing trader, or long-term investor, you hold the reins.",
    },
  ];
  ...
  export const plans = [
    {
      ...
      priceMonthly: 19,
      priceYearly: 0.0033,
      caption: "Try out our service ",
      features: [
        "Daily BTC analysis",
        "Portfolio Management + Premium Crypto Signals ",
    ...
    },
    {
      ...
      features: [
        ...
        "Lifetime access to all of ATZ services",
  ...
  export const whatWeOffer = [
    {
      ...
      comment3:"Cherrypicking ONLY the best trading opportunities",
    },
    {
      id: "0",
      name: "Education",
      ...
      comment:
        ...
        comment3:"Advanced:  Risk management tools Best ATZ trading strategies, Price action concepts, indicators, TRICKS you won’t find anywhere else.",
    },
    
    {
      ...
      comment3:"we will help! Anything trading related we are at your service!",
    },
    {
      id: "3",
